...
if (-not (Test-Path "$vs\Common7\IDE\Extensions\TestPlatform\CommonExtensions")) {
    ...
    cmd /c mklink "$vs\Common7\IDE\Extensions\TestPlatform\CommonExtensions\Platform\Microsoft.VisualStudioTools.VSTestHost.15.0.dll" "$vs\Common7\IDE\CommonExtensions\Platform\Microsoft.VisualStudioTools.VSTestHost.15.0.dll" | Out-Null
}
